...
import { Settings, Activity, Terminal as TerminalIcon, Users } from 'lucide-react';
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
          >
            <TerminalIcon className="w-5 h-5 text-gray-600 dark:text-dark-300" />
          </motion.button>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
          >
            <Users className="w-5 h-5 text-gray-600 dark:text-dark-300" />
          </motion.button>
